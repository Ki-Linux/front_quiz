...
<div id="rule">
    <div class="use">
        <h1>ご利用に関して</h1>
        <ul>
            <li>1.本サービスのご利用に際してユーザー登録やログインは必要ありません。</li>
            <li>2.本サービスは、運営者個人の判断による情報であることから、情報の正確さに関しては保証いたしかねます。</li>
            <li>3.情報の誤りに関するご指摘は、<router-link to="/form">お問い合わせ</router-link>からお願いいたします。</li>
            <li>4.平均点の表示は、小数第2位以下の数字を四捨五入しております。(小数第1位が0の場合は、整数として表示されます。)</li>
            <li>5.予告なく変更、追加、削除を行うことがあります。</li>
        </ul>
    </div>
    <div class="privacy">
        <h1>プライバシーポリシー</h1>
        <ul>
            <li>本サービスは、SendGridのメール送信APIサービスを用いるため、
            ...
            <li>Twilio社及び国内代理店に関しては
                ...
                こちら</a>
                をご覧ください。</li>
            <li>本サービスによって保持したメールアドレスに関しては、本サービスの範囲で利用します。</li>
        </ul>
    </div>
    <div class="back">
